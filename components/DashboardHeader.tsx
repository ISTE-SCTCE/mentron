...
const APP_FEATURES = [
    ...
    { name: 'Groups', path: '/chairman', roles: ['chairman'] },
                            ...
                            {searchResults.groups.length > 0 && (
                                <div className="p-2 border-t border-[var(--glass-border)]">
                                    ...
                                    {searchResults.groups.map((item) => (
                                        <button key={item.id} onClick={() => handleResultClick(`/groups/${item.id}`)} className="w-full text-left px-3 py-2 rounded-lg hover:bg-white/5 flex items-center gap-2 group">
                            ...
                            {searchResults.students.length > 0 && (
                                <div className="p-2 border-t border-[var(--glass-border)]">
                                    ...
                                    {searchResults.students.map((item) => (
                                        <button key={item.id} onClick={() => handleResultClick(`/${userRole}/students?tab=students&studentId=${item.id}`)} className="w-full text-left px-3 py-2 rounded-lg hover:bg-white/5 flex items-center gap-2 group">
